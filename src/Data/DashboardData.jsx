...
export const headDashboardData = [
  {
    image: (
      <Link to={'/product/product_left_sidebar/1'}>
        <img src='/assets/images/fashion/product/front/1.jpg' alt='fashion' height={70} width={46} />
      </Link>
    ),
  ...
  {
    image: (
      <Link to={'/product/product_left_sidebar/2'}>
        <img src='/assets/images/fashion/product/front/2.jpg' alt='fashion' height={70} width={46}/>
      </Link>
    ),
  ...
  {
    image: (
      <Link to={'/product/product_left_sidebar/3'}>
        <img src='/assets/images/fashion/product/front/3.jpg' alt='fashion' height={70} width={46}/>
      </Link>
    ),
  ...
  {
    image: (
      <Link to={'/product/product_left_sidebar/4'}>
        <img src='/assets/images/fashion/product/front/4.jpg' alt='fashion' height={70} width={46}/>
      </Link>
    ),
  ...
  {
    image: (
      <Link to={'/product/product_left_sidebar/5'}>
        <img src='/assets/images/fashion/product/front/5.jpg' alt='fashion' height={70} width={46}/>
      </Link>
    ),
