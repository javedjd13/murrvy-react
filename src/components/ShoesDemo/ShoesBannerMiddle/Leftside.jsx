...
import { ShopNow } from "../../../constant/index";
    ...
    <Col lg="6" className="ratio2_1">
      <div className="collection-banner p-right text-right">
        ...
        <div className="banner-text">
          <div className="banner-content">
            <h6>
              {elem.leftbanner.titleleft}{" "}
              <span className="theme-color">
                {elem.leftbanner.titleright}
              </span>
            </h6>

            <h2>
              {elem.leftbanner.headingtop} <br />
              {elem.leftbanner.headingbottom}
              <span className="theme-color d-block">
                {symbol}
                {(elem.leftbanner.price * currencyValue).toFixed(2)}
              </span>
            ...
            <Btn
              attrBtn={{
                className:
                  "default-light default-theme mt-md-2 mt-1 rounded",
                onClick: () =>
                  navigate("/shop"),
              }}
            >
